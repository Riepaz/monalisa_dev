...
"norecord"			=> "Tidak Ada Data Ditemukan",  
 ...
 "notepassword"			=> "Kosongkan jika telah selesai",  
 "submit"			=> "Daftar",  
 "signin"			=> "Masuk",  
 "signup"			=> "Daftarkan",  
 "language"			=> "Bahasa",  
 ...
 "registernew"			=> "Daftakan Akun Baru ",  
 "backtosite"			=> "Kembali Ke Halaman",  
 ...
 "Curriculum"			=> "Struktur Pembelajaran",  
 "Site"			=> "Site",  
 "Learning"			=> "Learning",  
 "Wishlist"			=> "Wishlist",  
...
<p><strong>All images will be reviewed to make sure they meet the requirements for publication, please </strong></p>",  
 ...
 "course_overview"			=> "Gambaran Kelas",  
...
<p>Set the price of your course and complete your premium instructor application so we can pay you. Or skip this step to leave your course free.</p>",  
 ...
 "True"			=> "True",  
 "False"			=> "False",  
 "Add_Lecture"			=> "Add Materi",  
 "Add_Quiz"			=> "Add Quiz",  
 "New_Lecture"			=> "Materi Baru",  
 "New_Quiz"			=> "New Quiz",  
 "quiz_title"			=> "Enter a Title",  
 "Add_Section"			=> "Add Bagian",  
...
<p>Set the price of your course and complete your premium instructor application so we can pay you. Or skip this step to leave your course free.</p>",  
 ...
 "address"=>"Alamat",
 "our_instructor" =>"Mentor Kami",
 "testimonial" =>"Testimoni",
 "enroll_course"=>"Ikuti Kelas",
 "course_features"=>"Fitur",
 "pages"=>"halaman",
 "duration"=>"durasi",
 "video"=>"video",
 "course_categories"=>"Kategori",
 "tags"=>"tag",
 "subscribe_to_course"=>"Ikuti Kelas",
 "checkout"=>"Konfirmasi",
 "subscription_status"=>"Status Subscription",
 "your_transaction_is_successful"=>"Transaksi anda berhasil",
 "your_transaction_is_failed"=>"Transaksi anda gagal",
 "go_to_course_learn_page"=>"Ke halaman pembelajaran",
 "return_to_course"=>"Kembali ke halaman detail kelas",
 "course_list"=>"Daftar Kelas",
 "filter_result"=>"Hasil Filter",
 "clear_filter"=>"Hapus Filter",
 "showing"=>"Menampilkan",
 "page"=>"Halaman",
 "of"=>"dari",
 "instructor_page"=>"Mentor Page",
 "explore_courses"=>"Jelajahi Daftar Kelas",
 "no_courses_yet"=>"Maaf, anda belum terdaftar di kelas manapun",
 "courses_taught_by"=>"Kelas yang dimentori",

"registration" => 'Pendaftaran',
"registasstudent" => 'Daftar Sebagai Peserta'
