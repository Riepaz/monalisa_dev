            ...
            <div class="col-lg-3 col-12 mt-1 ">
                <div class="card bg-primary-01 px-3 py-4 border-0 shadow-none ">
                    ...
                    <div class="ml-2 my-3 offset-2 text-center">
                        <div class="my-2">
                            <h1 class="fas fas fa-chart-line text-info"></h1>
                        </div>
                        <p class="">Statistik</p>
                        <h5><b>{{ $title }}</b></h5>
                    </div>
                        ...
                        <table
                            ...
                            <thead>
                                <tr class="table-light">
                                    ...
                                    <th class="text-center">Jumlah Kecamatan yang Melaksanakan Mekop</th>
...
function openTblProvince() {
    ...
    mekop_province_table = $('.mekop_province_table').dataTable({
        ...
        "ajax": {
            "url": "{{ route('getallstatrealizeprov.realize') }}",
            "type": "POST",
            "headers": {
...
function openTblRegency(id, name) {
    ...
    mekop_regency_table = $('.mekop_regency_table').dataTable({
        ...
        "ajax": {
            "url": "{{ route('getallstatrealizeregency.realize') }}",
            "type": "POST",
            "headers": {
                "X-CSRF-TOKEN": "{{ csrf_token() }}",
            },
