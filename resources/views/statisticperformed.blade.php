            ...
            <div class="col-lg-3 col-12 mt-1 ">
                <div class="card bg-primary-01 px-3 py-4 border-0 shadow-none ">
                    ...
                    <div class="ml-2 my-3 offset-2 text-center">
                        <div class="my-2">
                            <h1 class="fas fas fa-award text-info"></h1>
                        </div>
                        <p class="">Statistik</p>
                        <h5><b>{{ $title }}</b></h5>
                    ...
                    <form id="form_statistictarget" method="POST" action="{{ route('exportperformed.realize') }}"
                        ...
                        <table
                            ...
                            <thead>
                                <tr class="table-light">
                                    ...
                                    <th class="text-center">Persentase Pelaksanaan Mekop</th>
                                </tr>
                                <tr class="table-light">
...
function openTblProvince() {
    ...
    mekop_province_table = $('.mekop_province_table').dataTable({
        ...
        "ajax": {
            "url": "{{ route('getallstatperformedprov.performed') }}",
            "type": "POST",
            "headers": {
...
function openTblRegency(id, name) {
    ...
    mekop_regency_table = $('.mekop_regency_table').dataTable({
        ...
        "ajax": {
            "url": "{{ route('getallstatperformedregency.performed') }}",
            "type": "POST",
            "headers": {
                "X-CSRF-TOKEN": "{{ csrf_token() }}",
            },
...
function openTblDistrict(id, name) {
    ...
    mekop_district_table = $('.mekop_district_table').dataTable({
        ...
        "ajax": {
            "url": "{{ route('getallstatperformeddistrict.performed') }}",
            "type": "POST",
            "headers": {
                "X-CSRF-TOKEN": "{{ csrf_token() }}",
            },
...
function openTblVillage(id, name) {
    ...
    mekop_village_table = $('.mekop_village_table').dataTable({
        ...
        "ajax": {
            "url": "{{ route('getallstatperformedvillage.performed') }}",
            "type": "POST",
            "headers": {
                "X-CSRF-TOKEN": "{{ csrf_token() }}",
            },
