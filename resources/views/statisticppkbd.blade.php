            ...
            <div class="col-lg-3 col-12 mt-1 ">
                <div class="card bg-primary-01 px-3 py-4 border-0 shadow-none">
                    ...
                    <div class="ml-2 my-3 offset-2 text-center">
                        <div class="my-2">
                            <h1 class="fas fas fa-users text-info"></h1>
                        </div>
                        <p class="">Statistik</p>
                        <h5><b>{{ $title }}</b></h5>
                    </div>

                    <form id="form_statistictarget" method="POST" action="{{ route('exportppkbd.ppkbd') }}"
                        ...
                        <table
                            ...
                            <thead>
                                <tr class="table-light">
                                    ...
                                    <th colspan="4" class="text-center">Klasifikasi PPKBD</th>
                                    <th rowspan="2" class="text-center">Rasio Terhadap Desa</th>
                                </tr>
                                <tr class="table-light">
                                    <th class="text-center">Dasar</th>
                                    <th class="text-center">Berkembang</th>
                        ...
                        <table
                            ...
                            <thead>
                                <tr class="table-light">
                                    ...
                                    <th colspan="3" class="text-center">Klasifikasi PPKBD</th>
...
function openTblProvince() {
    ...
    mekop_province_table = $('.mekop_province_table').dataTable({
        ...
        "ajax": {
            "url": "{{ route('getallstatppkbdprov.ppkbd') }}",
            "type": "POST",
            "headers": {
...
function openTblRegency(id, name) {
    ...
    mekop_regency_table = $('.mekop_regency_table').dataTable({
        ...
        "ajax": {
            "url": "{{ route('getallstatppkbdregency.ppkbd') }}",
            "type": "POST",
            "headers": {
                "X-CSRF-TOKEN": "{{ csrf_token() }}",
            },
...
function openTblDistrict(id, name) {
    ...
    mekop_district_table = $('.mekop_district_table').dataTable({
        ...
        "ajax": {
            "url": "{{ route('getallstatppkbddistrict.ppkbd') }}",
            "type": "POST",
            "headers": {
                "X-CSRF-TOKEN": "{{ csrf_token() }}",
            },
